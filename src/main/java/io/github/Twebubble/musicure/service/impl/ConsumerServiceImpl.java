...
import static io.github.Twebubble.musicure.constant.Constants.SALT;
...
public class ConsumerServiceImpl extends ServiceImpl<ConsumerMapper, Consumer> implements ConsumerService {
    ...
    public R addUser(ConsumerRequest registryRequest) {
        ...
        //使用 Spring 的 BeanUtils.copyProperties 将请求对象属性拷贝到实体对象
        ...
        } catch (DuplicateKeyException e) {     //捕获可能发生的唯一键冲突异常（例如并发情况下可能出现的重复插入）
