<template>
    <div class="play-list-container">
        <musicure-nav :styleList="singerStyle" :activeName="activeName" @click="handleChangeView"></musicure-nav>
...
import MusicureNav from "@/components/layouts/MusicureNav.vue";
