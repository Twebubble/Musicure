            ...
            <li class="card-frame" v-for="(item, index) in playList" :key="index">
                <div class="card" @click="goAblum(item)">
                    ...
                    <div class="mask" @click="goAblum(item)">
                        <musicure-icon class="mask-icon" :icon="BOFANG"></musicure-icon>
                    </div>
                </div>
...
import MusicureIcon from "@/components/layouts/MusicureIcon.vue";
...
export default defineComponent({
    ...
    props: {
        ...
        // playList: Array,
        playList: {
            type: Array as PropType<PlayListItem[]>, // 指定数组元素类型
            default: () => []
        },
        path: String,
    },
